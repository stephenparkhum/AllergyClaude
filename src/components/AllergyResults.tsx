    ...
    <div className="space-y-6" data-testid="allergy-results">
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              ...
              <p
                className={`text-sm font-source-sans-pro mt-1 ${
                  hasDefiniteAllergens
          ...
          {hasDefiniteAllergens && (
            <div className="mb-4" data-testid="detected-allergens">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4
                  className="text-base font-medium text-red-700 dark:text-red-300 font-playfair"
        ...
        <Card className="shadow-md" data-testid="ingredients-card">
          <CardContent className="p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h4 className="font-semibold font-playfair text-lg" id="ingredients-heading">
            ...
            <div className="space-y-4">
              ...
              {results.safe_ingredients.length > 0 && (
                <div>
                  <h5 className="text-sm font-semibold text-green-700 dark:text-green-300 mb-2 font-playfair">
                    SAFE INGREDIENTS:
                  </h5>
              ...
              {results.warning_ingredients.length > 0 && (
                <div>
                  <h5 className="text-sm font-semibold text-orange-700 dark:text-orange-300 mb-2 font-playfair">
                    CAUTION INGREDIENTS:
                  </h5>
                  <div className="flex flex-wrap gap-2">
              ...
              {results.unsafe_ingredients.length > 0 && (
                <div>
                  <h5 className="text-sm font-semibold text-red-700 dark:text-red-300 mb-2 font-playfair">
                    UNSAFE INGREDIENTS:
                  </h5>
                  <div className="flex flex-wrap gap-2">
      ...
      {results.analysis && (
        <Card className="shadow-md" data-testid="analysis-card">
          <CardContent className="p-6">
            <h4 className="font-semibold mb-4 font-playfair text-lg" id="analysis-text-heading">
              DETAILED ANALYSIS:
            </h4>
            <div
